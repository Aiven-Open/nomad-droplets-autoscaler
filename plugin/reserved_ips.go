...
func (r *ReservedAddressesPool) AssignIPv4(
	...
	if _, _, err := r.reservedIPActions.Assign(ctx, ipv4, droplet.ID); err != nil {
		return fmt.Errorf(
...
func (r *ReservedAddressesPool) AssignIPv6(
	...
	if _, _, err := r.reservedIPV6Actions.Assign(ctx, ipv6, droplet.ID); err != nil {
		return fmt.Errorf(
	...
	r.logger.Info("assigned reserved IPv6 address", "IPv6 address", ipv6)
